...
abstract class _ShopHomeViewModelBase with Store implements BaseViewModel {
  ...
  @override
  late ReactiveContext context; // ReactiveContext türünde context tanımla

  @override
  void setContext(ReactiveContext context) =>
      this.context = context; // ReactiveContext olarak değiştirildi
